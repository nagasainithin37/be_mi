...
//No of probles solved
    ...
    resObj['noOfProblemsSolved']=parseInt(prblm.slice(14,prblm.length-1))??0
...
//No Of Contests
   ...
   if(Number.isNaN(resObj['noOfContests']))
   resObj['noOfContests']=0
   if(Number.isNaN(resObj['noOfProblemsSolved']))
   resObj['noOfProblemsSolved']=0
   if(Number.isNaN(resObj['rating']))
   resObj['rating']=0
